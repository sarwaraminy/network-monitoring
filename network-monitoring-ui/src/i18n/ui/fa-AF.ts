...
export const UI_FA_AF: Readonly<Partial<Record<UiMessageKey, string>>> = {
  ...
  'flow.binding_stale': 'در حال شنود است، اما نه روی بندر پیکربندی‌شده',
  'flow.binding_stale_note':
    'سوکت پیش از خواندن تنظیمات کنونی باز شده، پس به {bound} بسته است در حالی که تنظیمات {configured} را می‌گوید. جریانی که به بندر پیکربندی‌شده فرستاده می‌شود نمی‌رسد. مدیر می‌تواند آن را از تنظیمات مدیریت ← تنظیمات گردآوری جریان دوباره باز کند.',
  ...
  'flow_settings.rebound_only':
    'چیزی برای تغییر نبود — تنظیمات از پیش درست بودند. سوکت دوباره باز شد و گوش ' + 'می‌دهد.',
  'flow_settings.retry_failed':
    'سوکت دوباره باز شد و باز هم نتوانست بسته شود، پس چیزی گردآوری نمی‌شود. شاید ' +
    'بندر هنوز اشغال باشد، یا نشانی بست روی این میزبان نباشد. چیزی ذخیره نشد — این ' +
    'مقادیر از پیش ذخیره بودند.',
  ...
  'flow_settings.saved_not_listening':
    ...
    'بست روی این میزبان نباشد. تنظیم ذخیره شده و در راه‌اندازی بعدی به کار می‌رود؛ وضعیت کنونی را ' +
    'صفحهٔ گردآوری جریان نشان می‌دهد.',
